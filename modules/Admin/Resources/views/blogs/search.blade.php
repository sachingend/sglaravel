<tr role="row" class="filter">
    ...
    <td>
        {!! Form::text('blog_name', null, ['class'=>'form-control form-filter']) !!}
    </td>
    <td>
        {!! Form::text('blog_seo_string', null, ['class'=>'form-control form-filter']) !!}
    </td>
    <td>
        {!! Form::text('blog_short_desc', null, ['class'=>'form-control form-filter']) !!}
    </td>
    <td>
        {!! Form::text('blog_desc', null, ['class'=>'form-control form-filter']) !!}
    </td>
    <td>
